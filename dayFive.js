...
var main = function(input) {
	...
	for (var i = 0; i < stringList.length; i++) {
		...
		if (vowelCheck(stringLetters) === true && doubleLetterCheck(stringLetters) === true && 
			badLetterCheck(stringLetters) === true) {
			niceCount += 1;
		}
	};
	return niceCount;
...
var mainTest = function() {
	var test1 = main('ugknbfddgicrmopn');
	console.log('test1 should be 1: ' + test1);

	var test2 = main('aaa');
	console.log('test2 should be 1: ' + test2);

	var test3 = main('jchzalrnumimnmhp');
	console.log('test3 should be 0: ' + test3);

	var test4 = main('haegwjzuvuyypxyu');
	console.log('test4 should be 0: ' + test4);

	var test5 = main('dvszwmarrgswjxmb');
	console.log('test4 should be 0: ' + test5);
};
